...
function divide(u1, v1, u4, v4, p1, p2, p3, p4, transform, limit, patchSize, ctx, img) {
  ...
  switch (amax) {
    case a1:
      ...
      if (u4 !== 1) padx = 1.5 / Mathsqrt(d12[0] * d12[0] + d12[1] * d12[1]);
      if (v4 !== 1) pady = 1.5 / Mathsqrt(d31[0] * d31[0] + d31[1] * d31[1]);
      break;
    case a2:
      ctx.transform(d12[0], d12[1],  d24[0],  d24[1], p2[0], p2[1]);      
      if (u4 !== 1) padx = 1.5 / Mathsqrt(d12[0] * d12[0] + d12[1] * d12[1]);
      if (v4 !== 1) pady = 1.5 / Mathsqrt(d24[0] * d24[0] + d24[1] * d24[1]);
      dx = -1;
      break;
    case a4:
      ctx.transform(-d43[0], -d43[1], d24[0], d24[1], p4[0], p4[1]);     
      if (u4 !== 1) padx = 1.5 / Mathsqrt(d43[0] * d43[0] + d43[1] * d43[1]);
      if (v4 !== 1) pady = 1.5 / Mathsqrt(d24[0] * d24[0] + d24[1] * d24[1]);
      dx = -1;
      dy = -1;
      break;
